...
var mouseover = function(){
    ...
    d3.select('p')
        .text('Circle radius = ' + circle.attr('r') + ' pixels.');
};

// Function for mouseout event
var mouseout = function(){
    var circle = d3.select(this);
    circle.attr('fill', '#bdbdbd');
...
/*
 ...
 .domain([60000, 0])// Hardcoded: Min and Max of feb data
 ...
 // Add text to p tag in the infobox div
 d3.select('p')
 .html('Care Continuum = ' + data[d][0]['Care Continuum'] + '<br/>'
 + 'Chronic Disease Management = ' + data[d][0]['Chronic Disease Management'] + '<br/>'
 + 'KP Education = ' + data[d][0]['KP Education'] + '<br/>'
 + 'MNP = ' + data[d][0]['MNP'] + '<br/>'
 + 'Visit X = ' + data[d][0]['Visit X'] + '<br/>'
 + 'Total = ' + data[d][0]['Total'] + '<br/>'
 + 'Date = ' + data[d][0]['date']
 );
 })
 .on('mouseout', mouseout)
